...
from hello import ghjk,openFiless
root =Tk()
...
root.iconbitmap('tkinter\images\logo_ico.ico')

#background Image
bg1 = Image.open('tkinter\images\moroccan-flower.png')
#resize
resize_bg=bg1.resize((900,800),Image.ANTIALIAS)
#define 
new_bg = ImageTk.PhotoImage(resize_bg)
compileImg = ImageTk.PhotoImage(Image.open('tkinter\images\logo.png'))
...
def frontPage():
    ...
    qsimg = ImageTk.PhotoImage(Image.open('tkinter\images\help_32.png')) 
...
def successpage():
    ...
    #img
    global img
    img = ImageTk.PhotoImage(Image.open('tkinter\images\success256.png'))
...
def tryAgain():
    ...
    #img
    global new_imgEmj
    imgEmj = Image.open('tkinter\images\emoji.png')
    #resize
...
def helpPage():
    ...
    global imgback
    imgback = ImageTk.PhotoImage(Image.open('tkinter\images\Back42.png'))
